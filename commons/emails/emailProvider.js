...
exports.passwordVerify = async (user) => {
  const htmlContent = `
	<div class="card text-center">
			<div class="card-body">
					<div class="card-title">Verify your password by code: <span style="background-color: #0d6efd!important;color: #fff!important;padding: .5rem!important;"><strong> ${ user.otp }</strong></span></div>
			</div>
	</div>
	`
  let mailOptions = {
